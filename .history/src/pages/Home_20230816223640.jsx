    ...
    return(
        ...
        <div className="hero py-16">
            <div className="container mx-auto flex item-center justify-between">
               ...
               <div className="w-1/2 flex flex-col items-start justify-center flex-start">
                <h6 className="text-lg"><em>Are you Hungry</em></h6>
                <h1 className="text-3xl md:text-5xl font-bold">Don't Wait !</h1>
                <button className="px-6 py-2 w-1/2 rounded-full text-white font-bold mt-4 bg-yellow-500
